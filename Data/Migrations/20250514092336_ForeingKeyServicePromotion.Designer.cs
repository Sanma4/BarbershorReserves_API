...
namespace Data.Migrations
{
    ...
    [Migration("20250514092336_ForeingKeyServicePromotion")]
    partial class ForeingKeyServicePromotion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Model.BookingDetails", b =>
                {
            ...
            modelBuilder.Entity("Model.EmployeeCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Model.Promotion", b =>
                {
                    ...
                    b.Property<int>("DiscountPercetange")
                        .HasColumnType("int");

                    b.Property<int>("PromotedServiceId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Model.ServiceCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Model.Booking", b =>
                {
                    b.HasOne("Model.Client", "Client")
                        .WithOne("Booking")
                        .HasForeignKey("Model.Booking", "ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Model.BookingDetails", b =>
                {
                    b.HasOne("Model.Booking", null)
                        .WithOne("BookingDetails")
                        .HasForeignKey("Model.BookingDetails", "BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Model.Employee", b =>
                {
                    ...
                    b.HasOne("Model.EmployeeCategory", "EmployeeCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("Model.Service", b =>
                {
                    b.HasOne("Model.ServiceCategory", "ServiceCategory")
                        .WithMany()
